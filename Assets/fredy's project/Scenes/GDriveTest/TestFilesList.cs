...
public class TestFilesList : AdaptiveWindowGUI
{
    ...
    private string folderID = "1d6qRTsme_ybQhNWujhYM_DBQdllBy-ZK";
    ...
    private void ListFiles (string nextPageToken = null)
    {
        ...
        request.Corpora = ("user"); //'user' (files created by, opened by, or shared directly with the user)
        request.OrderBy = ("name"); //orders files by name
